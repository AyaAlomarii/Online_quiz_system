<template>
 ...
 >
     <q-card
       class="  q-pa-sm height-190 bg-white text-black"
       
      
    >
      <q-card-section class="br-8 row justify-between">
        <div class="row ">
          <q-icon name="description" size="sm" class="q-pt-md q-mr-md" color="black"/>
      ...
      <q-card-section class=" column text-body2 text-grey q-py-none">
        ...
        <q-btn  class=" bg-attempt   text-primary "  outline size="md" no-caps
        :disable="quiz.status==='active'?true:false"
        :to="RoutesPaths.QUESTIONS" >Attempt</q-btn>
      </div>
      </q-card-section>
