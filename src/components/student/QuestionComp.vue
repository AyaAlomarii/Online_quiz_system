<template>
  <div class="row q-pa-sm justify-center height-271">
    <div class="col-lg-11 col-xlg-11 col-md-8 col-sm-10 q-pa-none">
      ...
      <div class=" row justify-end text-h5 end-text ">
        {{ timer }} min
      </div>
      <q-stepper
        v-model="step"
    ...
    <div class="row q-py-lg full-width justify-between">
      ...
      <q-card>
        ...
        <q-card-actions align="right" class="q-pa-md">
          <q-btn flat label="Cancel" class="br-8 q-px-md bg-white"
          outline
          color="red"
          size="md"
          dense
          ...
          dense
          no-caps
          class="br-8 bg-red q-pa-lg " text-color="white" 
...
const handelSubmit=()=>{
//object and compare it to the correct answer
handelScore()
