<template>
  <q-layout view=" hHh lpR fFf" class="bg-bg-grey">
    <!-- Header -->
    ...
    <!-- footer -->
    <q-footer bordered class=" row justify-center bg-bg-grey heigh-54px ">
